...
def parse_handle():
    ...
    parser.add_argument('--path_to_indx', help="path to save indices for correct answers", type=str, default='/home/kkuvshinova/tpower_attack/data/correct')
    parser.add_argument('--path_to_answers', help="path to answers of non-attacked model", type=str, default='/home/kkuvshinova/tpower_attack/data/answers')
    ...
    parser.add_argument('--path_to_imagenet', help="path to imagenet data", type=str, default='/media/ssd-3t/kkuvshinova/ImageNet')
