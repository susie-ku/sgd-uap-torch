...
def parse_handle():
    ...
    parser.add_argument('--path_to_indx', help="path to save indices for correct answers", type=str, default='/image/tpower_q/data/correct')
    parser.add_argument('--path_to_answers', help="path to answers of non-attacked model", type=str, default='/image/tpower_q/data/answers')
